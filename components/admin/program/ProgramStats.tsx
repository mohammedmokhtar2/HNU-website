    ...
    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6'>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className='text-xs text-muted-foreground'>Per college</p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          <div className='text-2xl font-bold'>
            {stats.byCollege.length > 0
              ? Math.max(...stats.byCollege.map(c => c.count))
              : 0}
          </div>
          <p className='text-xs text-muted-foreground'>In one college</p>
        </CardContent>
      </Card>
                    ...
                    <div className='flex-1 min-w-0'>
                      <p className='text-sm font-medium truncate'>
                        {typeof college.collageName === 'string'
                          ? college.collageName
                          : (college.collageName as any)?.en ||
                            (college.collageName as any)?.ar ||
                            'Unknown College'}
                      </p>
                      {typeof college.collageName === 'object' &&
                        (college.collageName as any)?.ar &&
                        (college.collageName as any)?.en && (
