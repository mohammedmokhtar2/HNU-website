...
export function BlogManagementPage({
    ...
    const [deletingBlog, setDeletingBlog] = useState<BlogWithRelations | null>(null);
    const [selectedBlogType, setSelectedBlogType] = useState<'all' | 'university' | 'college'>('all');
    ...
    const handleBlogTypeChange = (type: 'all' | 'university' | 'college') => {
        ...
        switch (type) {
            ...
            case 'college':
                ...
                break;
            default:
                setQueryParams({ universityId: undefined, collageId: undefined, page: 1 });
        }
    };
            ...
            <Card>
                ...
                <CardContent>
                    <div className="flex flex-col sm:flex-row gap-4">
                        ...
                        {/* Blog Type Filter */}
                        <Select value={selectedBlogType} onValueChange={handleBlogTypeChange}>
