                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <Select
                                value={
                                    queryParams.isPublished === true ? 'published' :
                                        queryParams.isPublished === false ? 'draft' : 'all'
                                }
                        ...
                        <div>
                            ...
                            <Select
                                value={
                                    queryParams.isFeatured === true ? 'featured' :
                                        queryParams.isFeatured === false ? 'not-featured' : 'all'
                                }
                            ...
                            <div className="flex flex-wrap gap-2 mt-2">
                                {queryParams.search && (
                                    <Badge variant="secondary" className="flex items-center gap-1">
                                        ...
                                        <X
                                            ...
                                            onClick={() => setQueryParams({ search: undefined, page: 1 })}
                                        />
                                    </Badge>
                                )}
                                {queryParams.isPublished !== undefined && (
                                    <Badge variant="secondary" className="flex items-center gap-1">
                                        ...
                                        <X
                                            className="h-3 w-3 cursor-pointer"
                                            onClick={() => setQueryParams({ isPublished: undefined, page: 1 })}
                                        />
                                    </Badge>
                                )}
                                {queryParams.isFeatured !== undefined && (
                                    <Badge variant="secondary" className="flex items-center gap-1">
                                        ...
                                        <X
                                            className="h-3 w-3 cursor-pointer"
                                            onClick={() => setQueryParams({ isFeatured: undefined, page: 1 })}
                                        />
                                    </Badge>
                                )}
                                {queryParams.universityId && (
                                    <Badge variant="secondary" className="flex items-center gap-1">
                                        ...
                                        <X
                                            className="h-3 w-3 cursor-pointer"
                                            onClick={() => setQueryParams({ universityId: undefined, page: 1 })}
                                        />
                                    </Badge>
                                )}
                                {queryParams.collageId && (
                                    <Badge variant="secondary" className="flex items-center gap-1">
                                        ...
                                        <X
                                            className="h-3 w-3 cursor-pointer"
                                            onClick={() => setQueryParams({ collageId: undefined, page: 1 })}
                                        />
                                    </Badge>
                                )}
                                {queryParams.tags && queryParams.tags.length > 0 && (
                                    <Badge variant="secondary" className="flex items-center gap-1">
                                        ...
                                        <X
                                            className="h-3 w-3 cursor-pointer"
                                            onClick={() => setQueryParams({ tags: undefined, page: 1 })}
                                        />
                                    </Badge>
                                )}
                            </div>
