                            ...
                            <div className='space-y-2'>
                                <label className='flex items-center gap-2'>
                                    <input
                                        ...
                                        className='rounded'
                                    />
                                    <span className='text-sm text-gray-300'>Show only featured blogs</span>
                                </label>
                                <label className='flex items-center gap-2'>
                                    <input
                                        type='checkbox'
                                        ...
                                        className='rounded'
                                    />
                                    <span className='text-sm text-gray-300'>Show university blogs</span>
                                </label>
                                <label className='flex items-center gap-2'>
                                    <input
                                        type='checkbox'
                                        ...
                                        className='rounded'
                                    />
                                    <span className='text-sm text-gray-300'>Show college blogs</span>
                                </label>
                            </div>
                        </div>
                    </div>
    ...
    return (
        <div className='space-y-6'>
            ...
            <div className='flex justify-end gap-2'>
                <Button type='button' variant='outline' onClick={() => { }} className='border-gray-600 text-gray-300 hover:bg-gray-700'>
                    Cancel
                </Button>
