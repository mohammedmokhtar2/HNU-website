...
export function UniversityCard({
    ...
    const universityImage = university.config?.logo || '/images/Placehold/university-placeholder.png';

    return (
        <Card
            className={`group hover:shadow-xl transition-all duration-300 cursor-pointer ${isSelected
