    ...
    const steps = useMemo(
        () => [
            ...
            },
            {
                ...
                description: 'Discover our programs, facilities, and academic opportunities',
                logo: '/logo2.png',
                duration: 1000,
            },
            {
                ...
                <div className='space-y-3 md:space-y-4'>
                    ...
                    <p
                        className={cn(
                            ...
                            currentStep === 0 && 'animate-fade-in-up-loading animation-delay-200',
                            currentStep === 1 && 'animate-fade-in-up-loading animation-delay-200',
                            currentStep === 2 && 'animate-fade-in-up-loading animation-delay-200'
                        )}
                    >
                    ...
                    <p
                        className={cn(
                            ...
                            currentStep === 0 && 'animate-fade-in-up-loading animation-delay-400',
                            currentStep === 1 && 'animate-fade-in-up-loading animation-delay-400',
                            currentStep === 2 && 'animate-fade-in-up-loading animation-delay-400'
                        )}
                    >
