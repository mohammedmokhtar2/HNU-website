        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-10 items-stretch'>
          ...
          <div className='md:col-span-2 flex flex-col justify-between bg-white/80 rounded-3xl shadow-2xl border border-blue-100 p-8 relative overflow-hidden group backdrop-blur-xl'>
            ...
            <p className='text-gray-600 mb-4 line-clamp-3 text-base md:text-lg'>
              {local === 'ar'
                ? featured.description.ar
                : featured.description.en}
            </p>
            <div className='flex items-center gap-4 text-sm text-gray-500'>
              <span>
                {local === 'ar' ? featured.author.ar : featured.author.en}
              </span>
              <span>•</span>
              <span>
                {local === 'ar' ? featured.date.ar : featured.date.en}
              </span>
                  ...
                  >
                    ...
                    >
                      ...
                      <div className='flex items-center gap-2 text-xs text-gray-400'>
                        <span>
                          {local === 'ar' ? item.date.ar : item.date.en}
                        </span>
                        <span>•</span>
                        <span>
                          {local === 'ar' ? item.readTime.ar : item.readTime.en}
                        </span>
                      </div>
                    </div>
                  </button>
