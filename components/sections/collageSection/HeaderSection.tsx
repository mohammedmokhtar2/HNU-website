...
function HeaderSection({ sectionId, sections }: { sectionId: string, sections: any }) {
    ...
    const getContentValue = (content: any, key: string, lang: 'ar' | 'en' = 'en') => {
    ...
    const mappedHeaderSection = {
        ...
        uniName: getContentValue(section?.universty, locale) || locale === "ar" ? "جامعة حلوان الاهليه" : "Helwan National Universty"
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                    ...
                    <div className="flex-1 text-center md:text-right">
                        <div className="space-y-2">
                            {/* College Name */}
                            <h1 className={`text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 leading-tight ${locale === "ar" ? "text-right!" : "text-left!"}`}>
                                {mappedHeaderSection.collageName || (locale === "ar" ? "كلية الآداب والعلوم" : "College of Arts and Sciences")}
                            </h1>
                            ...
                            {/* University Name */}
                            <h2 className={`text-lg md:text-xl text-gray-600 font-medium ${locale === "ar" ? "text-right!" : "text-left!"}`}>
