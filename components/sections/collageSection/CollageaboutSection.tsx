...
import { Star, Sparkles, Play, Users, GraduationCap, Award, Calendar, MapPin } from 'lucide-react';
...
const CollageaboutSection = ({ sectionId, sections }: CollageaboutSectionProps) => {
    ...
    const aboutData = {
        ...
        description: {
            en: content.content?.en || 'Our college is committed to providing excellent education and preparing students for successful careers.',
            ar: content.content?.ar || 'كليتنا ملتزمة بتقديم تعليم متميز وإعداد الطلاب لحياة مهنية ناجحة.',
        },
                        ...
                        >
                            ...
                            >
                                <p className='text-lg sm:text-xl text-blue-100 leading-relaxed'>
                                    {aboutData.description[locale as keyof typeof aboutData.description]}
                                </p>

                                {/* College Description */}
                                {collage?.description && (
                                    <p className='text-base sm:text-lg text-blue-200 leading-relaxed'>
                                        {collage.description[locale as keyof typeof collage.description]}
                                    </p>
                                )}
                            </motion.div>
