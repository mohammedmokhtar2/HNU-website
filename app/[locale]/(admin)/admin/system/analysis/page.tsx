...
const prepareChartData = (analytics: AnalyticsData) => {
        ...
        datasets: [
            {
                ...
                backgroundColor: COLORS.slice(0, analytics.distributions.collegeTypes.length),
                borderWidth: 2,
                borderColor: '#fff',
            },
        ],
        ...
        datasets: [
            {
                ...
                backgroundColor: COLORS.slice(0, analytics.distributions.userRoles.length),
                borderWidth: 2,
                borderColor: '#fff',
            },
        ],
        ...
        datasets: [
            {
                ...
                backgroundColor: COLORS.slice(0, analytics.distributions.sectionTypes.length),
                borderWidth: 2,
                borderColor: '#fff',
            },
        ],
    ...
    const topCollegesData = {
        labels: analytics.topPerformers.collegesByPrograms.map(item =>
            typeof item.name === 'object' ? item.name.en || item.name.ar || 'Unknown' : item.name
        ),
        datasets: [
            {
                label: 'Programs',
                data: analytics.topPerformers.collegesByPrograms.map(item => item.count),
    ...
    const topUniversitiesData = {
        ...
        datasets: [
            {
                label: 'Colleges',
                data: analytics.topPerformers.universitiesByColleges.map(item => item.count),
    ...
    const blogTagsData = {
        ...
        datasets: [
            {
                data: analytics.distributions.blogTags.slice(0, 10).map(item => item.count),
        ...
        datasets: [
            {
                ...
                backgroundColor: COLORS.slice(0, analytics.distributions.actions.length),
                borderWidth: 2,
                borderColor: '#fff',
            },
        ],
    ...
    const messageStatusData = {
        labels: analytics.messageAnalytics.statusDistribution.map(item => item.status),
        datasets: [
            {
                data: analytics.messageAnalytics.statusDistribution.map(item => item.count),
    ...
    const messagePriorityData = {
        labels: analytics.messageAnalytics.priorityDistribution.map(item => item.priority),
        datasets: [
            {
                data: analytics.messageAnalytics.priorityDistribution.map(item => item.count),
    ...
    const messageTypeData = {
        ...
        datasets: [
            {
                data: analytics.messageAnalytics.typeDistribution.map(item => item.count),
                backgroundColor: COLORS.slice(0, analytics.messageAnalytics.typeDistribution.length),
                borderWidth: 2,
                borderColor: '#fff',
            },
        ],
    ...
    const hourlyMessageData = {
        labels: analytics.messageAnalytics.hourlyDistribution.map(item => `${item.hour}:00`),
        datasets: [
            {
                label: 'Messages per Hour',
                data: analytics.messageAnalytics.hourlyDistribution.map(item => item.count),
...
function AnalysisPage() {
                ...
                <Card className='bg-transparent'>
                    <CardContent className='p-6'>
                        <div className='text-center'>
                            ...
                            <Button onClick={fetchAnalytics} className='text-white border-white'>
                                Try Again
                            </Button>
                        </div>
                    </CardContent>
    ...
    return (
        <div className='space-y-6'>
            ...
            {/* Tab Navigation */}
            <div className='flex space-x-1 bg-transparent border border-white rounded-lg p-1'>
                {tabs.map((tab) => {
                    const Icon = tab.icon;
                    return (
                        <button
                    ...
                    <Card className='bg-transparent border-2 border-white rounded-lg'>
                        ...
                        <CardContent>
                            <div className='space-y-4'>
                                {analytics.recentActivity.systemActivity.slice(0, 5).map((activity, index) => (
                                    <div key={index} className='flex items-center justify-between p-3 bg-white/5 rounded-lg'>
                                        <div className='flex items-center gap-3'>
                                            <div className='w-2 h-2 bg-green-500 rounded-full'></div>
                                            <div>
                                                <p className='text-white font-medium'>{activity.action}</p>
                                                <p className='text-white/70 text-sm'>{activity.entity}</p>
                                            </div>
                                        </div>
                                ...
                                <div className='flex items-center justify-between p-3 bg-white/5 rounded-lg'>
                                    <div className='flex items-center gap-3'>
                                        ...
                                        <div>
                                            ...
                                            <p className='text-white/70 text-sm'>All data relationships are valid</p>
                                        </div>
                                    </div>
                                ...
                                <div className='flex items-center justify-between p-3 bg-white/5 rounded-lg'>
                                    <div className='flex items-center gap-3'>
                                        ...
                                        <div>
                                            ...
                                            <p className='text-white/70 text-sm'>All systems operating normally</p>
                                        </div>
                                    </div>
                                    <Badge variant='outline' className='text-green-500 border-green-500'>
                                        Optimal
                                ...
                                <div className='flex items-center justify-between p-3 bg-white/5 rounded-lg'>
                                    <div className='flex items-center gap-3'>
                                        ...
                                        <div>
                                            ...
                                            <p className='text-white/70 text-sm'>Last backup completed successfully</p>
                                        </div>
                                    </div>
                                    <Badge variant='outline' className='text-green-500 border-green-500'>
                                        Up to Date
                ...
                <div className='space-y-6'>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6'>
                        ...
                        <Card className='bg-transparent border-2 border-white rounded-lg'>
                            ...
                            <CardContent>
                                <div className='text-2xl font-bold text-white'>
                                    {analytics.messageAnalytics.performanceMetrics.averageResponseTime}
                                </div>
                                <p className='text-xs text-white'>
                    ...
                    <Card className='bg-transparent border-2 border-white rounded-lg'>
                        ...
                        <CardContent>
                            <div className='space-y-4'>
                                {analytics.messageAnalytics.recentMessages.slice(0, 5).map((message: any, index: number) => (
                                    <div key={index} className='flex items-center justify-between p-3 bg-white/5 rounded-lg'>
                                        <div className='flex items-center gap-3'>
                                            ...
                                            <div>
                                                ...
                                                <p className='text-white/70 text-sm'>
                                                    {message.messageConfig?.type || 'Unknown'} • {message.messageConfig?.status || 'Unknown'}
                                                </p>
                                            </div>
                                        </div>
                                        <div className='text-right'>
