...
import { Bell, User, LogOut, Settings, HelpCircle, Moon, Sun, ChevronDown } from 'lucide-react';
  ...
  return (
    <header className={cn(
      ...
      <div className="flex items-center space-x-2">
        ...
        {/* badge for version */}
        <Badge variant="outline" className="text-xs bg-yellow-500/70 text-white">{process.env.NEXT_PUBLIC_VERSION}</Badge>
      </div>
