  ...
  try {
    ...
    const college = await db.college.update({
      ...
      data: {
        ...
        studentsCount: studentsCount !== undefined ? studentsCount : undefined,
        programsCount: programsCount !== undefined ? programsCount : undefined,
...
export const { PUT } = withApiTrackingMethods(
  { PUT: handlePUT },
